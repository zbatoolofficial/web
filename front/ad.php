  ...
  <div class="container-fluid home-section ">
    <nav>
      <div class="sidebar-button">
        <i class='bx bx-menu sidebarBtn text-light'></i>
        <span class="dashboard text-warning">Dashboard</span>
      </div>
      ...
      <div class="profile-details">
        <!--<img src="images/profile.jpg" alt="">-->
         <span class="admin_name">Zahra Batool</span>
    ...
    <div class="row">
     <center> <h2 style="color:black;font-family: sans-serif;font-weight: bold;">Contact Form</h2></center>
        <div class="col-md-12">
            <table class="table table-striped mt-2" style="background-color:#051220;color:#fff;">
                <thead>
                    <tr>
                        <th scope="col">ID</th>
    ...
    <!-- #dc3545 -->
    <div class="row">
     <center> <h2 style="color:black ;font-family: sans-serif;font-weight: bold;">SignUp Form</h2></center>
        <div class="col-md-12">
            <table class="table table-striped mt-2" style="background-color:#051220;color:#fff;">
                <thead>
                    <tr>
